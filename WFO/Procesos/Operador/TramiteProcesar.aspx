...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <script>
        ...
        function AlertaMotivosSeleccionCompleta() {
            new PNotify({
                title: 'Debe seleccionar al menos una mesa. !',
                text: 'Por favor seleciona una mesa.',
                type: 'error',
                styling: 'bootstrap3'
            });
        }
        ...
        function BuscarTramite() {
            window.open('BuscarTramite2.aspx', 'Buscar Tramite', 'width = 800, height = 600');
        }
    </script>
    <style>
        .btn-danger {
            background: linear-gradient(-45deg,#d32929,#b70000)!important;
        }
    </style>
    <!-- Campos Ocultos -->
    <div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <asp:Repeater ID="rptBitacoraPrivada" runat="server" >
                                <HeaderTemplate>
                                    <table id="datatableBitacora" class="table table-striped table-bordered jambo_table bulk_action">
                                        <thead>
                                            <tr>
                                                <th>Numero</th>
                                                <th>Mesa</th>
    ...
    <!-- MODAL DE CONFIRMACION ACEPTAR -->
    <div class="modal fade confirmacion" id="ContinuarFusionarExpediente" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title" id="myModalLabel2">
                        <asp:label ID="Label82" runat="server" Text="Confirmación de movimiento">
                        </asp:label>
                    </h4>
                </div>
                <div class="modal-body text-center">
                    <h5 class="modal-title" id="myModalLabel2">
                        <asp:Label runat="server" ID="Label83" Text="¿ Deseas funcionar los archivos al expediente ?"></asp:Label>
                    </h5>
                </div>
                <div class="modal-footer text-center">
                    <div class="row text-center">
                        <button type="button" class="btn btn-default col-md-6 col-sm-6 col-xs-12" data-dismiss="modal">Cancelar</button>
                        <asp:Button ID="Button6" runat="server" Text="Aceptar" class="btn btn-primary col-md-5 col-sm-5 col-xs-12" CausesValidation="False" OnClick="btnFucionarAExpedite_Click"  />
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <asp:Repeater ID="rptExpedientes" runat="server" >
                                <HeaderTemplate>
                                    <table id="" class="table table-striped table-bordered jambo_table bulk_action">
                                        <thead>
                                            <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <asp:Repeater ID="RepeterCoasegurados" runat="server" >
                                    <HeaderTemplate>
                                        <table id="datatable" class="table table-striped table-bordered table-responsive jambo_table bulk_action">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                ...
                <div class="x_content text-left" >
                    <div class="row">
                        ...
                        <div class="control-label col-md-7 col-sm-12 col-xs-12">
                            ...
                            <asp:Panel ID="PanelSeleccionCompletaChecs" runat="server" Visible="false">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h3><small>Enviar a mesas </small> </h3>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content text-left" >
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <asp:CheckBox ID="CheckBoxRevisioTecnica"  runat="server" AutoPostBack="True" Text=" REVISIÓN TÉCNICA" />
                                                <br />
                                                <asp:CheckBox ID="CheckBoxRevisionMedica"  runat="server" AutoPostBack="True" Text=" REVISIÓN MÉDICA" /> 
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <asp:Button ID="Button5" Visible="true" ValidationGroup="Observaciones" runat="server" Text="Enviar" class="btn btn-success col-md-6 col-sm-6 col-xs-12" title="Aceptar" OnClick="btnSeleccionCompleta_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="control-label col-md-5 col-sm-5 col-xs-12">
                            ...
                            <%--<asp:LinkButton ID="LinkButton4"  CausesValidation="false" runat="server" class="btn btn-info col-md-4 col-sm-4 col-xs-12"  title="Buscar Tramite" Text="" OnClick="BtnBuscarTramiteAbrir_click"><i class="fa fa-desktop"></i> Buscar tramite</asp:LinkButton>--%>
                            
                            <button type="button" class="btn btn-info col-md-4 col-sm-4 col-xs-12" title="Buscar Tramite" onclick="BuscarTramite()"><i class="fa fa-desktop"></i> Buscar tramite </button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="x_content text-left">
                            ...
                            <div class="row">
                                <div class=" profile_details">
                                        ...
                                        <div class="right col-xs-12 text-left">
                                            <asp:UpdatePanel ID="PnlArchivosAnexos" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <br />
                                                    <asp:Button ID="btnSubirDocumento" runat="server" Text="Subir" class="btn btn-info col-md-4 col-sm-4 col-xs-12" CausesValidation="False" OnClick="btnSubirDocumento_Click"/><br />
                                                    <br /><br />
                                                    <asp:Literal id="ListArchivos" runat=server  text=""/>
                                                    <hr />
                                                     
                                                    <%--<asp:Button ID="ButFucionarAExpediente" runat="server" Text="Funcionar a expedite" class="btn btn-success col-md-4 col-sm-4 col-xs-12" CausesValidation="False" OnClick="btnFucionarAExpediteModal_Click"/>--%>
                                                ...
                                                <Triggers>
                                                    ...
                                                    <%--<asp:PostBackTrigger ControlID="ButFucionarAExpediente" />--%>
                                                </Triggers>
                                            </asp:UpdatePanel>
                                           <br />
                                            <asp:Button ID="ButFucionarAExpediente" runat="server" Text="Funcionar a expedite" class="btn btn-success col-md-4 col-sm-4 col-xs-12" CausesValidation="False" OnClick="btnFucionarAExpediteModal_Click"/>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 well profile_view" id="ContenidoExpedienteArchivo">
                                    </div>
<%--                                <div class="col-md-6 col-sm-6 col-xs-12 well profile_view">
                                        <div class="col-xs-12 bottom text-center">
                                            <h4 class="brief">ARCHIVOS CON DOCUMENTOS REQUERIDOS</h4><br />
   ...
   <!-- Botones Emergentes Cancelar -->
    ...
    <script>
        ...
        function CargaNuevaFucion()
        {
            $('#ContenidoExpedienteArchivo').html("");
            $('#ListaArchivosNuevos').html("");
            BajarScrolll();

        }

        function BajarScrolll() {
            var $elem = $('#div1');
        ...
        function EliminarArchivo(num) {
            ...
            $.ajax({
                type: "POST",
                url: "TramiteProcesar.aspx/EliminarArchivo",
                data: '{ Id: ' + num + '}',
        ...
        function resultado(data) {
            ...
            var contenido = "";
                contenido += "" +
                    "<table  id='exampleArchivos' class='table table-striped table-bordered jambo_table bulk_action' style='width:100%'>" +
                    "<thead>" +
                    "<tr>" +
                        "<th>Nombre</th>" +
                        "<th>Vista Previa</th>" +
                ...
                for (var i = 0; i < data.d.length; i++) {
                    contenido +=
                        "<tr>" +
                            ...
                            "</td>" +
                            "<td>" +
                                "<button type='button' class='btn btn-info col-md-12 col-sm-12 col-xs-12' title='Vista previa' OnClick='VistaPreviaArchivo(" + data.d[i].Id_Archivo + ")'><i class='fa fa-eye'></i></button>" +
                            "</td>" +
                            "<td>" +
                                "<button type='button' class='btn btn-danger col-md-12 col-sm-12 col-xs-12' title='Eliminar' OnClick='EliminarArchivo(" + data.d[i].Id_Archivo + ")'><i class='fa fa-trash'></i></button>" +
                            "</td>" +
                        "</tr>";
                }
            ...
            $('#ListaArchivosNuevos').html(contenido);
        }

        function VistaPreviaArchivo(num) {
            $('#ContenidoExpedienteArchivo').html("");
            $.ajax({
                type: "POST",
                url: "TramiteProcesar.aspx/DetalleExpedienteArchivo",
                data: '{ Id: ' + num + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: resultadoVista,
                error: errores
            });
        }

        function resultadoVista(data) {
            var iframe = document.createElement("iframe");
            iframe.width = '100%';
            iframe.height = '700px';
            iframe.src = data.d; //Aqui iría el src de tu archivo .PDF
            $('#ContenidoExpedienteArchivo').append(iframe);
